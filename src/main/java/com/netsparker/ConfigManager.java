...
public class ConfigManager {
	...
	public boolean hasCredentials() {
		return (AppCommon.IsUrlValid(get(ScanRequestBase.API_URL_Literal))
				&& AppCommon.IsNullOrEmpty(get(ScanRequestBase.API_TOKEN_Literal)));
	}
	...
	private String getBuildParameter(String buildSpecificKey, String key) {
		...
		String parameterKey = pluginSpecificBuildKey + ":" + key;
		Object value =
				bandanaManager.getValue(PlanAwareBandanaContext.GLOBAL_CONTEXT, parameterKey);
